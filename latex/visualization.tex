...
\paragraph{Klassifizierungsverfahren für Tumoren} Vom System wird gefordert, Klassifizierungsalgorithmen\footnote{Klassifikation - Prozess, um einem einzelnen Datenelement eine Farbe und Transparenz zuzuordnen (vgl. \cite[Kapitel 3.2.2, Seite 28]{Bruckner2004})}\footnote{Anmerkung: Die hier behandelte Klassifizierung ist nicht mit der Klassifikation von Tumoren im Sinne einer systematischen Einordnung anhand spezifischer Eigenschaften zu verwechseln} ausführen zu können, die
