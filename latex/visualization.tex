...
\begin{center}
 ...
 \large\textsc{Seminararbeit im W-Seminar \glqq Medizinische Bildgebungsverfahren\grqq}\\[1.5cm]
 {\Huge \textbf{3D-Tumorvisualisation}}\\[1cm]

 \begin{tabular}{ll}
  \textsc{Verfasser:} & Ulrich Köhler\\
  \textsc{W-Seminar:} & Medizinische Bildgebungsverfahren\\
  \textsc{Kursleiter:} & Herr. Bartels\\[2cm]
 \end{tabular}

\begin{tabular}[c]{|l|m{38mm}|m{38mm}|m{38mm}|}\hline
& \scriptsize schriftlich, einfache Wertung &\scriptsize mündlich &\scriptsize gesamt\\\hline
Erzielte Note & & &\\\hline
