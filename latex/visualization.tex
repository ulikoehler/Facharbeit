...
\end{enumerate}
Exemplarisch wird die Verarbeitung von CT-Eingabedaten anschaulich in \fref{fig:gradientmapping-graphic} dargestellt, wobei die Umsetzung von Eingabedaten in Objekte im dreidimensionalen Koordinatensystem der Einfachheit halber unberücksichtigt bleibt.
...
\fref{fig:vertebra-screenshot} zeigt VERTEBRAs Darstellung eines Gesunden Gewebes\footnote{Quelle der DICOM-Daten: Visible Human Project; Männlicher Pelvis -- 1mm CT-Schnittbilder; \textsc{vhm.501.dcm} bis \textsc{vhm.515.scm}; Verwendet wurde ein Weichteil-Hounsfield-Fenster mit einer Breite von 350 HU bei einem Zentrum bei 50 HU}; deutlich zu sehen sind teils volltransparente Gebiete (durch die der schwarze Hintergrund zu sehen ist) sowie die in der Signalfarbe rot angezeigten Knochen. Ein gut auszumachender, weil stark absorbierender Tumor, würde ebenfalls rot angezeigt werden.
