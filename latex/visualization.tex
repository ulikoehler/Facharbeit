...
\begin{itemize}
 ...
 \item VIRIM ist eine massiv-parallele, echtzeitfähige Volumenrenderingarchitektur, die in \cite{Günther1995} beschrieben wird
 \item In \cite{Meißner2002} beschreiben Meißner et al. VIZARD II, eine interaktive und rekonfigurierbare Volumenrenderingarchitektur
\end{itemize}
Insbesondere bei \cite{Knittel1995} sowie \cite{Günther1995} ist zu beachten, dass das Publikationsdatum sehr lange zurückliegt und daher unter Umständen die Kriterien nicht
